    ...
    <head>
        ...
        <style>
            @keyframes backgroundAnimation {
                0% { background-image: url('css/download (1).jpeg'); }
                33% { background-image: url('css/download.jpeg'); }
                66% { background-image: url('css/images (1).jpeg'); }
                100% { background-image: url('css/images.jpeg'); }
            }
